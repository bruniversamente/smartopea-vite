...
export interface ApiComentarioComentario extends Schema.CollectionType {
  ...
  attributes: {
    aprovado: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMensagemMensagem extends Schema.CollectionType {
...
export interface ApiProcessoProcesso extends Schema.CollectionType {
  ...
  attributes: {
    contratoSocial: Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    cpfCnpj: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::processo.processo',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    dataFimObra: Attribute.Date;
    dataInicioObra: Attribute.Date;
    detalhesEquipamento: Attribute.Text;
    documentId: Attribute.String;
    emailCliente: Attribute.Email;
    emailProprietario: Attribute.Email;
    enderecoObjeto: Attribute.Text;
    enderecoProprietario: Attribute.Text;
    equipamentosTemporarios: Attribute.Boolean;
    material: Attribute.String;
    nomeEmpreendimento: Attribute.String;
    nomeProprietario: Attribute.String;
    publishedAt: Attribute.DateTime;
    situacaoObra: Attribute.Enumeration<
      ['N\u00E3o Iniciada', 'Em Andamento', 'Conclu\u00EDda']
    >;
    statusProcesso: Attribute.Enumeration<
      [
        'Cadastro Recebido',
        'Em An\u00E1lise',
        'Aguardando Cliente',
    ...
    >;
    telefoneProprietario: Attribute.String;
    termoOutorga: Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiSimulacaoSimulacao extends Schema.CollectionType {
  collectionName: 'simulacaos';
  info: {
    displayName: 'Simulacao';
    pluralName: 'simulacaos';
  ...
  attributes: {
    ...
    parecerEnviado: Attribute.Boolean;
    publishedAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::simulacao.simulacao',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::processo.processo': ApiProcessoProcesso;
